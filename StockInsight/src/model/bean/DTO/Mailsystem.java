...
public class Mailsystem {
	...
	public void sendEmail(String from, String to, String subject, String content) throws Exception {
		...
		props.put("mail.smtp.host", "smtp.gmail.com");// SMTP 서비스 주소(호스트) -> 지메일이라서,, 변경,,, 이걸로 안하면 1번 오류 발생
		...
		//Session mailSession = Session.getDefaultInstance(props, auth); 2번오류로 아래와 같이 수정함 kjh
